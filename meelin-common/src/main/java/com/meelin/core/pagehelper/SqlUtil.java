...
import com.meelin.core.pagehelper.parser.Parser;
import com.meelin.core.pagehelper.parser.impl.AbstractParser;
import com.meelin.core.pagehelper.sqlsource.PageDynamicSqlSource;
import com.meelin.core.pagehelper.sqlsource.PageProviderSqlSource;
import com.meelin.core.pagehelper.sqlsource.PageRawSqlSource;
import com.meelin.core.pagehelper.sqlsource.PageSqlSource;
import com.meelin.core.pagehelper.sqlsource.PageStaticSqlSource;
...
public class SqlUtil implements Constant {
    ...
    private boolean isQueryOnly(Page page) {
        return page.isOrderByOnly()
                || ((page.getPageSizeZero() != null && page.getPageSizeZero()) && page.getLength() == 0);
    }
    ...
    private Page doQueryOnly(Page page, Invocation invocation) throws Throwable {
        ...
        page.setLength(page.size());
        //仍然要设置total
        page.setRecordsTotal(page.size());
    ...
    private Page doProcessPage(Invocation invocation, Page page, Object[] args) throws Throwable {
        ...
        if (page.isCount()) {
            ...
            args[0] = ms;
            //设置总数
            page.setRecordsTotal((Integer) ((List) result).get(0));
